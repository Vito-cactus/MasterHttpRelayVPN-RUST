...
3. **`Telegram publish release files`** — posts each binary individually to the Telegram channel `mhrv_rs` (`-1003966234444`) with Persian captions, SHA-256 hashes, and a cross-link from the main channel. Takes ~1-2 minutes.
